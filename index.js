...
btnEnviar.onclick = (event) => {
  event.preventDefault(); // impede que a página seja recarregada / comportamento padrão.
  // alert('Formulário enviado!');

  // selecionando campos do formuário.
  ...
  let inputVegano = document.querySelector(`input[name="vegano"]`);
